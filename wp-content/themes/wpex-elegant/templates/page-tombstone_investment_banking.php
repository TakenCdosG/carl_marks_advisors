<?php
/**
 * Template Name: Standard page tombstone Investment Banking
 *
 * @package WordPress
...
$args = array(
    ...
    'meta_query' => array(
        array(
            ...
            'value' => $InvestmentBankingCategory,
            'compare' => '='
        ),
    )
);
...
$wp_query_total = new WP_Query($args_total);
$post_count = $wp_query_total->post_count;
                ...
                <div class="page-content"> 
                    <div class="row header-table header-type-tombstone">
                        <div class="wrapper-col-3">
                            ...
                            <div class="col-lg-3 wrapper-industry-info">
                    ...
                    <div class="row wrapper-box-tombstone">
                        <div id="grid">
                            <?php if ($wp_query->have_posts()) : ?>
                                ...
                                <?php while ($wp_query->have_posts()): ?>
                                    ...
                                    <?php if (is_array($professionals)): ?>
                                        ...
                                        <?php foreach ($professionals as $key => $value): ?> 
                                            ...
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                        <?php if ($query_professional != "all"): ?>
                                            <?php if(!in_array($query_professional, $professionals)):?>
                                                 <?php $show_post = FALSE; ?>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        ...
                                        <?php if ($query_professional != "all"): ?>
                                            <?php if ($query_professional != $professionals): ?>
                                                 <?php $show_post = FALSE; ?>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <!-- End Sort Professionals -->
                                    <?php if ($show_post): ?>
                                                ...
                                                <div class="col-lg-4 box-tombstone">
                                                    <div class="wrapper-sort-by-name">
                                                        ...
                                                        <div class="read-more-wrapper">
                                                            <a class="learn-more" href="javascript: void(0)<?php echo get_permalink($post->ID) ?>">LEARN MORE <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <?php endwhile; ?>
                            <?php else : ?>
                                <h2 class="blog-title">There are no Tombstones matching you search criteria.</h2>
                            <?php endif; ?>
                        </div>
                        <div class="pagination">
                            ...
                            <?php if($post_count  > 0): ?>
                                <?php $custom_total = $post_count  / $posts_per_page; ?>
                            <?php endif; ?>

                            <?php $custom_total = ceil($custom_total); ?>
                            <?php //die(var_dump(array($total, $custom_total))); ?>
                            <?php wpex_custom_pagination($custom_total); ?>

                        </div>
                        <div class="footer-box span_3_of_3 col col-3" style="margin: 0px;"><p style="color: #000;display: block;position: relative;margin: 10px 0px 0px 0px;"><i>*Securities offered through Carl Marks Securities LLC, a member of FINRA and SIPC</i></p></div>
                    </div><!-- .row -->
                    <div class="clear clearfix"></div>
                </div><!-- .page-content -->
            </div><!-- #content -->
