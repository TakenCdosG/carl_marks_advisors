                        ...
                        <div class="comment-details clr">
                            <header class="comment-meta">
                                ...
                                <span class="comment-date">
                                    <?php
                                    printf('<a href="%1$s"><time datetime="%2$s">%3$s</time></a>', esc_url(get_comment_link($comment->comment_ID)), get_comment_time('c'), sprintf(_x('%1$s', '1: date', 'wpex'), get_comment_date())
                                    );
