                ...
                <div id="homepage-slider" class="flexslider">
                    <ul class="slides clr">
                        ...
                        foreach ($wpex_query->posts as $post) : setup_postdata($post);
                            ...
                            $wpex_get_featured_img_url = wpex_get_featured_img_url($attachment_id);
                            ...
                            <li class="homepage-slider-slide">
                                <?php if ('' !== $url) { ?>
                                    ...
                                    <div class="homepage-slide-inner container visible-xs" style="margin: 0;padding: 0;width: 100%; overflow: hidden;background-size: cover;background-position: center;background-image: url(<?php echo $attachment_url; ?><?php //echo wpex_get_featured_img_url(); ?>);height: 525px;display: block;position: relative;max-width:100%;">
                                        <div class="homepage-slide-content">
                                         <!-- <div class="homepage-slide-title"><?php the_title(); ?></div> -->
                                            <?php if ('' != $caption) { ?>
                                                <div class="clr"></div>
                                    ...
                                    <img src="<?php echo $attachment_url;?><?php //echo wpex_get_featured_img_url($attachment_id); ?>" alt="<?php echo $title; ?>">
